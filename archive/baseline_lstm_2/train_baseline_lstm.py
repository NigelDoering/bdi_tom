...
- LSTMGoalPredictionModel (lstm + classifier)
...
from models.baseline_lstm.lstm_predictor import LSTMGoalPredictionModel
...
def main(args):
    ...
    model = LSTMGoalPredictionModel(
        fusion_encoder=fusion_encoder,
        num_poi_nodes=len(poi_nodes),
        fusion_dim=args.fusion_dim,
        hidden_dim=args.predictor_hidden_dim,
        lstm_layers=args.num_lstm_layers,
        dropout=args.dropout
    )
    ...
    if args.use_wandb:
        ...
        config['model_name'] = 'baseline_lstm'  # Identifier for this model type
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoints/baseline_lstm',
    ...
    parser.add_argument('--num_lstm_layers', type=int, default=1,
                    help='Number of LSTM layers in goal prediction head')
